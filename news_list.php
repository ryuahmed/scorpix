    ...
    <section  class="container bodycont"  >
        ...
        <?php
          ...
          <div class="newslist">
              ...
              for($x=0 ; $x<$news->num_rows; $x++)
              {
      
                ?>
                <div class="bold listpace" align="left"><?php echo $newsdata['title']; ?><div class="smalltext">date : <?php echo $newsdata['added']; ?></div><a href="news.php?news_id=<?=$newsdata['news_id'];?>" class="see">see more</a> </div>
