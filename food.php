...
where reciver ='$username' and seen is NULL";
    ...
    <section id="showcase">
      ...
      <h1 align="center">Food </h1>
        <div>we take order in counter 30 min before moive starts</div>
      <?php
        $user = 'root';
        $pass = '';
         $db = 'scorpix';
        ...
        $qry = "SELECT f_name , f_price , link
                FROM food
                  "
                  ;
        ...
        for($x=0 ; $x<$foodcount ; $x++ )
          {
              ...
              <div class="boxes">
                     <div class="gallery">
                        <img src="image/food/<?php echo $food_data['link']?>.png">
                         <div class="desc"><?php echo $food_data['f_name'];?> </br>
                                  <?php echo $food_data['f_price'];?> tk
                         </div>
                      </div>
                  </div>
           <?php
